 ...
 *
 */
exports.logo = function(name, cb) {

	fs.readFile(__dirname + '/logo.txt', 'utf8', function(err, logo) {
		raft.log.info(name, '')
		...
		raft.log.info(name, _logo)
		raft.log.info(name, '')
		raft.log.info(name, 'If all went well raft should end with "' + 'Raft ok!'.green + '"')
		raft.log.info(name, '')
		cb()
	});
};
