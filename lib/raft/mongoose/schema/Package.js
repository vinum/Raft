...
console.log(drone.stats)
			new raft.mongoose.DroneStats({
				"package_id" : self._id,
				"drone_id" : _drone._id,
				"comm" : drone.stats.comm,
				"etime" : drone.stats.comm,
				"pcpu" : drone.stats.comm,
				"rssize" : drone.stats.comm,
				"time" : drone.stats.comm,
				"user" : drone.stats.comm,
				"vsz" : drone.stats.comm,
			}).save(loop)
		})
	}
