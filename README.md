...
A test to see how well haibu works for my needs. This fork may become a replacement for raft.
...
The domain attribute is required and will represent the user who started up a drone.

    {
      "domain": "my-cool-sub-domain"
    }
